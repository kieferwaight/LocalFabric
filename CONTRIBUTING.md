...
2. Make changes — keep the scope of one PR to one logical unit.
3. Format + lint: `make format lint`.
4. Test: `uv run pytest`.
5. Architecture audit: `make audit`. Findings land in `14_data/runs/classification_audit/`.
6. Open a PR. The merge requires a clean audit.
