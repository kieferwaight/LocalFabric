...
| --- | --- | --- | --- | --- |
| `command` | `string` | yes | `-` | [Run Command](definition-stdlib.run-command.md) |
| `working_dir` | `string` | no | `{{ env.cwd }}` | [Run Command](definition-stdlib.run-command.md) |
...
| --- | --- | --- |
| Run | `bash` | [Run Command](definition-stdlib.run-command.md) |
