...
| --- | --- | --- | --- | --- |
| `message` | `string` | yes | `-` | [Logger](definition-builtin-logger.md) |
| `level` | `string` | no | `INFO` | [Logger](definition-builtin-logger.md) |
...
| --- | --- | --- |
| Run | `python` | [Logger](definition-builtin-logger.md) |
