...
| --- | --- | --- | --- | --- |
| `directory_path` | `string` | yes | `-` | [Create Directory](definition-stdlib.files.create-directory.md) |
...
| --- | --- | --- |
| Run | `artifact` | [Create Directory](definition-stdlib.files.create-directory.md) |
