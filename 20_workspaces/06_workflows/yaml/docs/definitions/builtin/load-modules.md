...
| Children | - |
| Mixin consumers | - |
| Modules | `stdlib.files.yaml`, `stdlib.git.yaml`, `stdlib.template.yaml`, `stdlib.doc.yaml` |
...
| `module_namespace` | `builtin` | [Load Standard Library Modules](load-modules.md) |
...
| --- | --- | --- |
| Run | `python` | [Abstract Base](../abstract/base.md) |
