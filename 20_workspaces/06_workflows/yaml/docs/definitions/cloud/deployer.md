...
| Mixins | [Timestamp](../mixin/timestamp.md), [Git Information](../mixin/git-info.md) |
| Children | - |
| Mixin consumers | - |
| Modules | - |
...
| --- | --- | --- | --- | --- |
| `service` | `string` | yes | `-` | [Cloud Deployer](deployer.md) |
| `replicas` | `number` | no | `3` | [Cloud Deployer](deployer.md) |
| `canary` | `boolean` | no | `false` | [Cloud Deployer](deployer.md) |
| `regions` | `array` | no | `us-east-1,us-west-2` | [Cloud Deployer](deployer.md) |
...
| `deploy_started_at` | `pending` | [Timestamp](../mixin/timestamp.md) |
| `git_short_sha` | `unknown` | [Git Information](../mixin/git-info.md) |
| `workspace` | `{{ env.cwd }}` | [Cloud Deployer](deployer.md) |
| `banner` | `[deploy v{{ runtime.version }}] {{ service }} -> {{ regions }}` | [Cloud Deployer](deployer.md) |
...
| --- | --- | --- |
| Run | `bash` | [Cloud Deployer](deployer.md) |
| Run | `python` | [Cloud Deployer](deployer.md) |
| Teardown | `bash` | [Cloud Deployer](deployer.md) |
