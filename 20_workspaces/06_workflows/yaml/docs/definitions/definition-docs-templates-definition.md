...
| Source | `templates/doc-definition.yaml` |
...
```mermaid
flowchart LR
  def_docs_templates_definition["Docs - Definition Page Template"]
```
...
| --- | --- | --- | --- | --- |
| `definition` | `object` | yes | `-` | [Docs - Definition Page Template](definition-docs-templates-definition.md) |
