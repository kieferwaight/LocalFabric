...
| --- | --- |
| Extends | [Write Text File](definition-builtin-files-write-text.md) |
| Mixins | - |
| Children | [Gitignore Template Example](definition-example-git-gitignore.md) |
| Mixin consumers | [Initialize Git Example](definition-example-git-init.md), [GitHub Repository Example](definition-example-git-github.md) |
| Modules | - |
