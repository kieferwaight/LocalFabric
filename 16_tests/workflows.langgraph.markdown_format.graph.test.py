...
def test_run_markdown_format_workflow(monkeypatch):
    # Patch format_markdown_with_lmstudio in its actual home to avoid real API call.
    # graph.py imports lib.text.format_markdown as nodes, so patch the source module.
    import lib.text.format_markdown as nodes
