...
2. Index the upstream stage artifacts so the agent — or a human reviewer —
...
1. `# Final — <slug>`
2. A short paragraph stating that this file is the frozen handoff and that
...
5. `## Follow-up ideas to drop into 01_ideas/ after this ships` — bulleted
