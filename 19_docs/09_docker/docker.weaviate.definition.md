...
| `DATA_PATH` | `string` | yes | `-` | [Weaviate Service](docker.weaviate.definition.md) |
| `WEAVIATE_HTTP_PORT` | `string` | no | `8085` | [Weaviate Service](docker.weaviate.definition.md) |
| `WEAVIATE_GRPC_PORT` | `string` | no | `50051` | [Weaviate Service](docker.weaviate.definition.md) |
...
| `services` | `{'weaviate': {'image': 'semitechnologies/weaviate', 'container_name': 'contentgraph-weaviate', 'restart': 'unless-stopped', 'environment': {'QUERY_DEFAULTS_LIMIT': '25', 'AUTHENTICATION_ANONYMOUS_ACCESS_ENABLED': 'true', 'PERSISTENCE_DATA_PATH': '/var/lib/weaviate', 'DEFAULT_VECTORIZER_MODULE': 'none', 'CLUSTER_HOSTNAME': 'node1'}, 'ports': ['{{ WEAVIATE_HTTP_PORT }}:8080', '{{ WEAVIATE_GRPC_PORT }}:50051'], 'volumes': ['{{ DATA_PATH }}:/var/lib/weaviate']}}` | [Weaviate Service](docker.weaviate.definition.md) |
