...
def_docker_n8n --> def_docker_base["Docker Service (Compose + Dockerfile)"]
```
...
| `DATA_PATH` | `string` | yes | `-` | [n8n Service](docker.n8n.definition.md) |
| `N8N_PORT` | `string` | no | `5678` | [n8n Service](docker.n8n.definition.md) |
| `N8N_HOST` | `string` | no | `localhost` | [n8n Service](docker.n8n.definition.md) |
| `GENERIC_TIMEZONE` | `string` | no | `UTC` | [n8n Service](docker.n8n.definition.md) |
...
| `services` | `{'n8n': {'image': 'n8nio/n8n:latest', 'container_name': 'localfabric-n8n', 'restart': 'unless-stopped', 'environment': {'N8N_HOST': '{{ N8N_HOST }}', 'N8N_PORT': '{{ N8N_PORT }}', 'N8N_PROTOCOL': 'http', 'WEBHOOK_URL': 'http://{{ N8N_HOST }}:{{ N8N_PORT }}/', 'GENERIC_TIMEZONE': '{{ GENERIC_TIMEZONE }}', 'N8N_DIAGNOSTICS_ENABLED': 'false', 'N8N_RUNNERS_ENABLED': 'true'}, 'ports': ['{{ N8N_PORT }}:5678'], 'volumes': ['{{ DATA_PATH }}:/home/node/.n8n']}}` | [n8n Service](docker.n8n.definition.md) |
