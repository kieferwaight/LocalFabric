...
| `DATA_PATH` | `string` | yes | `-` | [Ollama Service](docker.ollama.definition.md) |
| `OLLAMA_PORT` | `string` | no | `11434` | [Ollama Service](docker.ollama.definition.md) |
...
| `services` | `{'ollama': {'image': 'ollama/ollama', 'container_name': 'contentgraph-ollama', 'restart': 'unless-stopped', 'ports': ['{{ OLLAMA_PORT }}:11434'], 'volumes': ['{{ DATA_PATH }}:/root/.ollama']}}` | [Ollama Service](docker.ollama.definition.md) |
