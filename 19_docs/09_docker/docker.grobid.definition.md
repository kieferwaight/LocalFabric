...
| `DATA_PATH` | `string` | yes | `-` | [GROBID Service](docker.grobid.definition.md) |
| `GROBID_PORT` | `string` | no | `8070` | [GROBID Service](docker.grobid.definition.md) |
...
| `services` | `{'grobid': {'image': 'lfoppiano/grobid:0.8.0', 'container_name': 'contentgraph-grobid', 'restart': 'unless-stopped', 'ports': ['{{ GROBID_PORT }}:8070'], 'volumes': ['{{ DATA_PATH }}:/opt/grobid/grobid-home/tmp']}}` | [GROBID Service](docker.grobid.definition.md) |
