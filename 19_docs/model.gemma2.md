...
| `name` | `gemma2` | [gemma2](model.gemma2.md) |
| `documentation` | `{'summary': 'Efficient general chat, summarization, question answering, and everyday\nlocal assistant use.\n', 'vendor': 'Google'}` | [gemma2](model.gemma2.md) |
| `providers` | `['ollama']` | [gemma2](model.gemma2.md) |
| `features` | `['text', 'streaming']` | [gemma2](model.gemma2.md) |
