...
| --- | --- | --- | --- | --- |
| `file_path` | `string` | yes | `-` | [Format a markdown file using a local LM Studio model](text.markdown.format.task.md) |
| `model` | `string` | no | `qwen/qwen3.6-27b` | [Format a markdown file using a local LM Studio model](text.markdown.format.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Format a markdown file using a local LM Studio model](text.markdown.format.task.md) |
