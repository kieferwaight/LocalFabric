...
| --- | --- | --- | --- | --- |
| `path` | `string` | yes | `-` | [Chunk a file into embeddable text segments](embeddings.chunker.chunk_file.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Chunk a file into embeddable text segments](embeddings.chunker.chunk_file.task.md) |
