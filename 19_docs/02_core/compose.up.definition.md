...
def_compose_up --> def_stdlib_run_command["Run Command"]
```
...
| `target_dir` | `string` | yes | `-` | [Docker Compose Up](compose.up.definition.md) |
...
| `command` | `docker compose -f {{ target_dir }}/docker-compose.yml up -d` | [Docker Compose Up](compose.up.definition.md) |
