...
def_launchd_generate_plist --> def_stdlib_base["Abstract Base"]
```
...
| --- | --- | --- | --- | --- |
| `output_dir` | `string` | no | `09_launchd` | [Generate launchd Plists](launchd.generate-plist.definition.md) |
| `mode` | `string` | no | `write` | [Generate launchd Plists](launchd.generate-plist.definition.md) |
...
| --- | --- | --- |
| Run | `launchd_plist` | [Generate launchd Plists](launchd.generate-plist.definition.md) |
