...
| --- | --- | --- | --- | --- |
| `output_dir` | `string` | no | `01_schemas` | [Generate Schema JSON](schemas.generate-json.definition.md) |
| `mode` | `string` | no | `write` | [Generate Schema JSON](schemas.generate-json.definition.md) |
| `indent` | `number` | no | `2` | [Generate Schema JSON](schemas.generate-json.definition.md) |
...
| --- | --- | --- |
| Run | `schema_json` | [Generate Schema JSON](schemas.generate-json.definition.md) |
