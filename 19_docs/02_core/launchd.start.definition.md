...
(`launchd.install`) for this to succeed.
...
def_launchd_start --> def_launchd_lifecycle_base["launchd Lifecycle Base"]
```
...
| `command` | `launchctl kickstart -k gui/$UID/{{ resolved_label }}` | [Start LaunchAgent](launchd.start.definition.md) |
