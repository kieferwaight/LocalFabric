...
def_service_postgres --> def_service_base["Service Abstraction Base"]
def_service_postgres -.-> def_service_docker_mixin["Docker Backend Action Map"]
```
...
| `backend` | `docker` | [Postgres Service (docker backend)](service.postgres.md) |
| `target` | `docker.postgres` | [Postgres Service (docker backend)](service.postgres.md) |
