...
| --- | --- | --- | --- | --- |
| `workspace` | `string` | no | `{{ env.cwd }}` | [Scan Boundary Violations](audit.boundary_violations.scan.task.md) |
| `output_dir` | `string` | no | `14_data/runs/classification_audit` | [Scan Boundary Violations](audit.boundary_violations.scan.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Scan Boundary Violations](audit.boundary_violations.scan.task.md) |
