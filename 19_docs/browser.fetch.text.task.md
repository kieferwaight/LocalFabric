...
| --- | --- | --- | --- | --- |
| `topic_or_url` | `string` | yes | `-` | [Fetch readable text from a URL or search topic](browser.fetch.text.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Fetch readable text from a URL or search topic](browser.fetch.text.task.md) |
