...
| --- | --- |
| Extends | - |
| Mixins | [Initialize Current Git Workspace](stdlib.git.init-current-workspace.md), [Write Python Gitignore](stdlib.git.gitignore-python.md), [Create GitHub Repository](stdlib.git.create-github-repository.md) |
| Children | - |
| Mixin consumers | - |
| Modules | - |
