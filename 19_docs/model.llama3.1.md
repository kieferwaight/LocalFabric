...
| `name` | `llama3.1` | [llama3.1](model.llama3.1.md) |
| `documentation` | `{'summary': 'General-purpose chat, instruction following, tool use, and long-context\nlocal assistant workflows.\n', 'vendor': 'Meta'}` | [llama3.1](model.llama3.1.md) |
| `providers` | `['ollama']` | [llama3.1](model.llama3.1.md) |
| `features` | `['text', 'tool_calling', 'streaming']` | [llama3.1](model.llama3.1.md) |
