...
| --- | --- | --- | --- | --- |
| `rel_path` | `string` | yes | `-` | [Classify a file by media type and destination](classify.media.file.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Classify a file by media type and destination](classify.media.file.task.md) |
