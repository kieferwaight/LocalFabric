...
| --- | --- | --- | --- | --- |
| `mode` | `string` | no | `write` | [Regenerate workflows.yaml Bucket Barrels](barrels.regenerate.yaml-runtime.md) |
...
| --- | --- | --- |
| Run | `invoke` | [Regenerate workflows.yaml Bucket Barrels](barrels.regenerate.yaml-runtime.md) |
| Run | `invoke` | [Regenerate workflows.yaml Bucket Barrels](barrels.regenerate.yaml-runtime.md) |
