...
| --- | --- | --- | --- | --- |
| `output_dir` | `string` | no | `09_launchd` | [Generate launchd Plists](launchd.generate-plist.md) |
| `mode` | `string` | no | `write` | [Generate launchd Plists](launchd.generate-plist.md) |
...
| --- | --- | --- |
| Run | `launchd_plist` | [Generate launchd Plists](launchd.generate-plist.md) |
