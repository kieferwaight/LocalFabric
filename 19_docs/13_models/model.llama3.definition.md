...
| --- | --- |
| ID | `model.llama3` |
| Source | `13_models/model.llama3.yaml` |
| Tags | model |
...
def_model_llama3 --> def_model_base["LLM Model Record"]
```
...
| `name` | `llama3` | [llama3](model.llama3.definition.md) |
| `documentation` | `{'summary': 'General-purpose chat, content generation, summarization, and\ninstruction-following tasks.\n', 'vendor': 'Meta'}` | [llama3](model.llama3.definition.md) |
| `providers` | `['ollama']` | [llama3](model.llama3.definition.md) |
| `features` | `['text', 'streaming']` | [llama3](model.llama3.definition.md) |
