...
| `name` | `qwen2.5` | [qwen2.5](model.qwen2.5.definition.md) |
| `documentation` | `{'summary': 'Multilingual chat, long-context work, coding assistance, and structured\ninstruction following.\n', 'vendor': 'Alibaba'}` | [qwen2.5](model.qwen2.5.definition.md) |
| `providers` | `['ollama']` | [qwen2.5](model.qwen2.5.definition.md) |
| `features` | `['text', 'tool_calling', 'streaming']` | [qwen2.5](model.qwen2.5.definition.md) |
