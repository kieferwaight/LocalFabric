...
| `target_dir` | `string` | yes | `-` | [Docker Compose Status](compose.status.md) |
...
| `command` | `docker compose -f {{ target_dir }}/docker-compose.yml ps` | [Docker Compose Status](compose.status.md) |
