...
| --- | --- | --- | --- | --- |
| `mode` | `string` | no | `write` | [Regenerate All Workflows Barrels](barrels.regenerate.workflow.md) |
...
| --- | --- | --- |
| Run | `invoke` | [Regenerate All Workflows Barrels](barrels.regenerate.workflow.md) |
| Run | `invoke` | [Regenerate All Workflows Barrels](barrels.regenerate.workflow.md) |
