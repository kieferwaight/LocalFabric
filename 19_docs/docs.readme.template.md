...
| --- | --- | --- | --- | --- |
| `project_tagline` | `string` | yes | `-` | [Docs - Repo README Template](docs.readme.template.md) |
| `buckets` | `array` | yes | `-` | [Docs - Repo README Template](docs.readme.template.md) |
| `cli_commands` | `array` | yes | `-` | [Docs - Repo README Template](docs.readme.template.md) |
