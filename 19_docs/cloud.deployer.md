...
| Mixins | [Timestamp](cloud.mixin.timestamp.md), [Git Information](cloud.mixin.git-info.md) |
| Children | - |
| Mixin consumers | - |
| Modules | - |
...
| --- | --- | --- | --- | --- |
| `service` | `string` | yes | `-` | [Cloud Deployer](cloud.deployer.md) |
| `replicas` | `number` | no | `3` | [Cloud Deployer](cloud.deployer.md) |
| `canary` | `boolean` | no | `false` | [Cloud Deployer](cloud.deployer.md) |
| `regions` | `array` | no | `us-east-1,us-west-2` | [Cloud Deployer](cloud.deployer.md) |
...
| `git_short_sha` | `unknown` | [Git Information](cloud.mixin.git-info.md) |
| `workspace` | `{{ env.cwd }}` | [Cloud Deployer](cloud.deployer.md) |
| `banner` | `[deploy v{{ runtime.version }}] {{ service }} -> {{ regions }}` | [Cloud Deployer](cloud.deployer.md) |
...
| --- | --- | --- |
| Run | `bash` | [Cloud Deployer](cloud.deployer.md) |
| Run | `python` | [Cloud Deployer](cloud.deployer.md) |
| Teardown | `bash` | [Cloud Deployer](cloud.deployer.md) |
