...
| --- | --- | --- | --- | --- |
| `source_dir` | `string` | no | `` | [Sweep and embed project files into the vector store](embeddings.sweep.workflow.md) |
| `manifest_path` | `string` | no | `` | [Sweep and embed project files into the vector store](embeddings.sweep.workflow.md) |
| `force` | `boolean` | no | `False` | [Sweep and embed project files into the vector store](embeddings.sweep.workflow.md) |
| `clear` | `boolean` | no | `False` | [Sweep and embed project files into the vector store](embeddings.sweep.workflow.md) |
| `dry_run` | `boolean` | no | `False` | [Sweep and embed project files into the vector store](embeddings.sweep.workflow.md) |
| `verbose` | `boolean` | no | `False` | [Sweep and embed project files into the vector store](embeddings.sweep.workflow.md) |
...
| --- | --- | --- |
| Run | `python` | [Sweep and embed project files into the vector store](embeddings.sweep.workflow.md) |
