...
| --- | --- | --- | --- | --- |
| `package_name` | `string` | yes | `-` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.md) |
| `package_doc` | `string` | no | `` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.md) |
| `modules` | `array` | yes | `-` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.md) |
| `flatten` | `boolean` | no | `True` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.md) |
