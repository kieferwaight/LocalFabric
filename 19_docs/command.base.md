...
| Mixins | - |
| Children | [Run Task](command.task.run.md), [Run a Service Lifecycle Action](command.service.action.md), [Route an Intent through the Router](command.route.md) |
| Mixin consumers | - |
| Modules | - |
...
| `argv_spec` | `{}` | [Abstract Command Base](command.base.md) |
| `http_spec` | `{}` | [Abstract Command Base](command.base.md) |
| `mcp_spec` | `{'expose': False}` | [Abstract Command Base](command.base.md) |
