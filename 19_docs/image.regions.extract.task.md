...
| --- | --- | --- | --- | --- |
| `path` | `string` | yes | `-` | [Detect content regions in an image](image.regions.extract.task.md) |
| `max_contours` | `number` | no | `20` | [Detect content regions in an image](image.regions.extract.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Detect content regions in an image](image.regions.extract.task.md) |
