...
| Extends | - |
| Mixins | - |
| Children | [launchd - Caffeinate](launchd.caffienate.md), [launchd - Docker](launchd.docker.md), [launchd - LM Studio](launchd.lm-studio.md), [launchd - Ollama](launchd.ollama.md) |
| Mixin consumers | - |
| Modules | - |
