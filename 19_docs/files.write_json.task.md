...
| --- | --- | --- | --- | --- |
| `path` | `string` | yes | `-` | [Write data to a JSON file](files.write_json.task.md) |
| `data` | `object` | yes | `-` | [Write data to a JSON file](files.write_json.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Write data to a JSON file](files.write_json.task.md) |
