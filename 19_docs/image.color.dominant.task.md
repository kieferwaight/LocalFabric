...
| --- | --- | --- | --- | --- |
| `path` | `string` | yes | `-` | [Extract dominant color palette from an image](image.color.dominant.task.md) |
| `n_colors` | `number` | no | `6` | [Extract dominant color palette from an image](image.color.dominant.task.md) |
...
| --- | --- | --- |
| Run | `python` | [Extract dominant color palette from an image](image.color.dominant.task.md) |
