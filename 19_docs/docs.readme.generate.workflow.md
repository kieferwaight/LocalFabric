...
| --- | --- | --- | --- | --- |
| `repo_root` | `string` | no | `{{ env.cwd }}` | [Build Repo README](docs.readme.generate.workflow.md) |
| `mode` | `string` | no | `write` | [Build Repo README](docs.readme.generate.workflow.md) |
...
| --- | --- | --- |
| Run | `python` | [Build Repo README](docs.readme.generate.workflow.md) |
| Run | `render` | [Build Repo README](docs.readme.generate.workflow.md) |
