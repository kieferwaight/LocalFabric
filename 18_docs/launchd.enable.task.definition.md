...
def_launchd_enable_task --> def_launchd_lifecycle_base["launchd Lifecycle Base"]
```
...
| `command` | `launchctl enable gui/$UID/{{ resolved_label }}` | [Enable LaunchAgent](launchd.enable.task.definition.md) |
