...
| --- | --- |
| ID | `model.gemma2` |
| Source | `13_models/model.gemma2.yaml` |
| Tags | model |
...
def_model_gemma2 --> def_model_base["LLM Model Record"]
```
...
| `name` | `gemma2` | [gemma2](model.gemma2.definition.md) |
| `documentation` | `{'summary': 'Efficient general chat, summarization, question answering, and everyday\nlocal assistant use.\n', 'vendor': 'Google'}` | [gemma2](model.gemma2.definition.md) |
| `providers` | `['ollama']` | [gemma2](model.gemma2.definition.md) |
| `features` | `['text', 'streaming']` | [gemma2](model.gemma2.definition.md) |
