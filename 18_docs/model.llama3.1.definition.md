...
| --- | --- |
| ID | `model.llama3.1` |
| Source | `13_models/model.llama3.1.yaml` |
| Tags | model |
...
def_model_llama3_1 --> def_model_base["LLM Model Record"]
```
...
| `name` | `llama3.1` | [llama3.1](model.llama3.1.definition.md) |
| `documentation` | `{'summary': 'General-purpose chat, instruction following, tool use, and long-context\nlocal assistant workflows.\n', 'vendor': 'Meta'}` | [llama3.1](model.llama3.1.definition.md) |
| `providers` | `['ollama']` | [llama3.1](model.llama3.1.definition.md) |
| `features` | `['text', 'tool_calling', 'streaming']` | [llama3.1](model.llama3.1.definition.md) |
