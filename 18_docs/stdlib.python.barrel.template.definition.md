...
| --- | --- | --- | --- | --- |
| `package_name` | `string` | yes | `-` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.definition.md) |
| `package_doc` | `string` | no | `` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.definition.md) |
| `modules` | `array` | yes | `-` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.definition.md) |
| `flatten` | `boolean` | no | `True` | [Python Barrel - __init__.py Template](stdlib.python.barrel.template.definition.md) |
