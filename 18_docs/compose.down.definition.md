...
| `target_dir` | `string` | yes | `-` | [Docker Compose Down](compose.down.definition.md) |
...
| `command` | `docker compose -f {{ target_dir }}/docker-compose.yml down` | [Docker Compose Down](compose.down.definition.md) |
