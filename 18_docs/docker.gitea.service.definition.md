...
| Source | `09_docker/docker.gitea.service.yaml` |
| Tags | docker, dev |
...
def_docker_gitea_service --> def_docker_base["Docker Service (Compose + Dockerfile)"]
```
...
| `DATA_PATH` | `string` | yes | `-` | [Gitea Service](docker.gitea.service.definition.md) |
| `GITEA_HTTP_PORT` | `string` | no | `3000` | [Gitea Service](docker.gitea.service.definition.md) |
| `GITEA_SSH_PORT` | `string` | no | `2222` | [Gitea Service](docker.gitea.service.definition.md) |
| `USER_UID` | `string` | no | `1000` | [Gitea Service](docker.gitea.service.definition.md) |
| `USER_GID` | `string` | no | `1000` | [Gitea Service](docker.gitea.service.definition.md) |
...
| `services` | `{'gitea': {'image': 'gitea/gitea:latest', 'container_name': 'contentgraph-gitea', 'restart': 'unless-stopped', 'environment': {'USER_UID': '{{ USER_UID }}', 'USER_GID': '{{ USER_GID }}', 'GITEA__database__DB_TYPE': 'sqlite3'}, 'ports': ['{{ GITEA_HTTP_PORT }}:3000', '{{ GITEA_SSH_PORT }}:22'], 'volumes': ['{{ DATA_PATH }}:/data']}}` | [Gitea Service](docker.gitea.service.definition.md) |
