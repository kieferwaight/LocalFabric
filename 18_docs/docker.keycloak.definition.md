...
| `DATA_PATH` | `string` | yes | `-` | [Keycloak Service](docker.keycloak.definition.md) |
| `KEYCLOAK_ADMIN` | `string` | yes | `-` | [Keycloak Service](docker.keycloak.definition.md) |
| `KEYCLOAK_ADMIN_PASSWORD` | `string` | yes | `-` | [Keycloak Service](docker.keycloak.definition.md) |
| `KEYCLOAK_PORT` | `string` | no | `8082` | [Keycloak Service](docker.keycloak.definition.md) |
