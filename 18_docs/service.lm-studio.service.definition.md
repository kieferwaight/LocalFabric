...
def_service_lm_studio_service --> def_service_base["Service Abstraction Base"]
def_service_lm_studio_service -.-> def_service_launchd_mixin["Launchd Backend Action Map"]
```
...
| `backend` | `launchd` | [LM Studio Service (launchd backend)](service.lm-studio.service.definition.md) |
| `target` | `launchd.lm-studio.service` | [LM Studio Service (launchd backend)](service.lm-studio.service.definition.md) |
