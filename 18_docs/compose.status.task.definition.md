...
def_compose_status_task --> def_stdlib_run_command_task["Run Command"]
```
...
| `target_dir` | `string` | yes | `-` | [Docker Compose Status](compose.status.task.definition.md) |
...
| `command` | `docker compose -f {{ target_dir }}/docker-compose.yml ps` | [Docker Compose Status](compose.status.task.definition.md) |
