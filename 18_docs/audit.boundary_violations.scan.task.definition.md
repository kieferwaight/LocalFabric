...
| Field | Value |
| --- | --- |
| ID | `audit.boundary_violations.scan.task` |
| Source | `07_tasks/audit.boundary_violations.scan.task.yaml` |
| Tags | task |
...
| --- | --- | --- | --- | --- |
| `workspace` | `string` | no | `{{ env.cwd }}` | [Scan Boundary Violations](audit.boundary_violations.scan.task.definition.md) |
| `output_dir` | `string` | no | `14_data/runs/classification_audit` | [Scan Boundary Violations](audit.boundary_violations.scan.task.definition.md) |
...
| --- | --- | --- |
| Run | `python` | [Scan Boundary Violations](audit.boundary_violations.scan.task.definition.md) |
