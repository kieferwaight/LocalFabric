...
def_service_caffeinate --> def_service_base["Service Abstraction Base"]
def_service_caffeinate -.-> def_service_launchd_mixin["Launchd Backend Action Map"]
```
...
| `backend` | `launchd` | [Caffeinate Service (launchd backend)](service.caffeinate.definition.md) |
| `target` | `launchd.caffeinate.service` | [Caffeinate Service (launchd backend)](service.caffeinate.definition.md) |
