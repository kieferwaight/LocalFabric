...
| --- | --- | --- | --- | --- |
| `topic_or_url` | `string` | yes | `-` | [Fetch and summarize content through a local model](research.local.summarize.task.definition.md) |
...
| --- | --- | --- |
| Run | `python` | [Fetch and summarize content through a local model](research.local.summarize.task.definition.md) |
