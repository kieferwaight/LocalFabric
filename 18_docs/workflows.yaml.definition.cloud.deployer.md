...
| --- | --- |
| ID | `cloud.deployer` |
| Source | `06_workflows/yaml/definitions/cloud.yaml` |
...
| Mixins | [Timestamp](workflows.yaml.definition.cloud.mixin.timestamp.md), [Git Information](workflows.yaml.definition.cloud.mixin.git-info.md) |
| Children | - |
| Mixin consumers | - |
| Modules | - |
...
| --- | --- | --- | --- | --- |
| `service` | `string` | yes | `-` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
| `replicas` | `number` | no | `3` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
| `canary` | `boolean` | no | `false` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
| `regions` | `array` | no | `us-east-1,us-west-2` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
...
| `deploy_started_at` | `pending` | [Timestamp](workflows.yaml.definition.cloud.mixin.timestamp.md) |
| `git_short_sha` | `unknown` | [Git Information](workflows.yaml.definition.cloud.mixin.git-info.md) |
| `workspace` | `{{ env.cwd }}` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
| `banner` | `[deploy v{{ runtime.version }}] {{ service }} -> {{ regions }}` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
...
| --- | --- | --- |
| Run | `bash` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
| Run | `python` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
| Teardown | `bash` | [Cloud Deployer](workflows.yaml.definition.cloud.deployer.md) |
