...
| Source | `09_docker/docker.grafana.service.yaml` |
...
def_docker_grafana_service --> def_docker_base["Docker Service (Compose + Dockerfile)"]
```
...
| `DATA_PATH` | `string` | yes | `-` | [Grafana Service](docker.grafana.service.definition.md) |
| `GF_SECURITY_ADMIN_USER` | `string` | yes | `-` | [Grafana Service](docker.grafana.service.definition.md) |
| `GF_SECURITY_ADMIN_PASSWORD` | `string` | yes | `-` | [Grafana Service](docker.grafana.service.definition.md) |
| `GRAFANA_PORT` | `string` | no | `3002` | [Grafana Service](docker.grafana.service.definition.md) |
