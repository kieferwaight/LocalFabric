...
| --- | --- | --- | --- | --- |
| `path` | `string` | yes | `-` | [Classify an image by semantic type](image.classify.task.definition.md) |
...
| --- | --- | --- |
| Run | `python` | [Classify an image by semantic type](image.classify.task.definition.md) |
