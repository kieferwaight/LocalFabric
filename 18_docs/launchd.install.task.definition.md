...
def_launchd_install_task --> def_launchd_lifecycle_base["launchd Lifecycle Base"]
```
...
| `plist_path` | `string` | no | `` | [Install LaunchAgent](launchd.install.task.definition.md) |
