...
| Mixins | - |
| Children | [Build Docker Image](docker.build.definition.md), [Docker Compose Up](compose.up.definition.md), [Docker Compose Down](compose.down.definition.md), [Docker Compose Status](compose.status.definition.md), [Docker Compose Logs](compose.logs.definition.md), [launchd Lifecycle Base](launchd.lifecycle.base.definition.md) |
| Mixin consumers | - |
| Modules | - |
