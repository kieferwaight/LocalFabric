...
| --- | --- | --- | --- | --- |
| `message` | `string` | yes | `-` | [Logger](stdlib.logger.definition.md) |
| `level` | `string` | no | `INFO` | [Logger](stdlib.logger.definition.md) |
...
| --- | --- | --- |
| Run | `python` | [Logger](stdlib.logger.definition.md) |
