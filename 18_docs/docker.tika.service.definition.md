...
| Field | Value |
| --- | --- |
| ID | `docker.tika.service` |
| Source | `09_docker/docker.tika.service.yaml` |
...
def_docker_tika_service --> def_docker_base["Docker Service (Compose + Dockerfile)"]
```
...
| `TIKA_PORT` | `string` | no | `9998` | [Apache Tika Service](docker.tika.service.definition.md) |
...
| `services` | `{'tika': {'image': 'apache/tika:latest-full', 'container_name': 'contentgraph-tika', 'restart': 'unless-stopped', 'ports': ['{{ TIKA_PORT }}:9998']}}` | [Apache Tika Service](docker.tika.service.definition.md) |
