...
| --- | --- | --- | --- | --- |
| `target_path` | `string` | yes | `-` | [Clean Workspace](workflows.yaml.definition.stdlib.clean-workspace.md) |
...
| --- | --- | --- |
| Run | `bash` | [Clean Workspace](workflows.yaml.definition.stdlib.clean-workspace.md) |
