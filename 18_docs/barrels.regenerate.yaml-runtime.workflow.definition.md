...
def_barrels_regenerate_yaml_runtime_workflow --> def_stdlib_base["Abstract Base"]
```
...
| --- | --- | --- | --- | --- |
| `mode` | `string` | no | `write` | [Regenerate workflows.yaml Bucket Barrels](barrels.regenerate.yaml-runtime.workflow.definition.md) |
...
| --- | --- | --- |
| Run | `invoke` | [Regenerate workflows.yaml Bucket Barrels](barrels.regenerate.yaml-runtime.workflow.definition.md) |
| Run | `invoke` | [Regenerate workflows.yaml Bucket Barrels](barrels.regenerate.yaml-runtime.workflow.definition.md) |
