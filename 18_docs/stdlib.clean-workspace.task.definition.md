...
def_stdlib_clean_workspace_task --> def_stdlib_base["Abstract Base"]
```
...
| --- | --- | --- | --- | --- |
| `target_path` | `string` | yes | `-` | [Clean Workspace](stdlib.clean-workspace.task.definition.md) |
...
| --- | --- | --- |
| Run | `bash` | [Clean Workspace](stdlib.clean-workspace.task.definition.md) |
