...
| `DATA_PATH` | `string` | yes | `-` | [Open WebUI Service](docker.open-webui.definition.md) |
| `OPEN_WEBUI_PORT` | `string` | no | `3001` | [Open WebUI Service](docker.open-webui.definition.md) |
| `OLLAMA_BASE_URL` | `string` | no | `http://ollama:11434` | [Open WebUI Service](docker.open-webui.definition.md) |
...
| `services` | `{'open-webui': {'image': 'ghcr.io/open-webui/open-webui:main', 'container_name': 'contentgraph-open-webui', 'restart': 'unless-stopped', 'environment': {'OLLAMA_BASE_URL': '{{ OLLAMA_BASE_URL }}'}, 'ports': ['{{ OPEN_WEBUI_PORT }}:8080'], 'volumes': ['{{ DATA_PATH }}:/app/backend/data']}}` | [Open WebUI Service](docker.open-webui.definition.md) |
