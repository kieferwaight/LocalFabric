...
| Mixins | - |
| Children | [Write Python Gitignore](workflows.yaml.definition.stdlib.git.gitignore-python.md), [Obsidian Daily Note Template](workflows.yaml.definition.obsidian.template.md) |
| Mixin consumers | - |
| Modules | - |
...
| `target_path` | `` | [Write Text File](workflows.yaml.definition.stdlib.files.write-text.md) |
| `content` | `` | [Write Text File](workflows.yaml.definition.stdlib.files.write-text.md) |
