...
| Artifact | Purpose |
| --- | --- |
| `03_schemas/audit.classification-finding.schema.yaml` | Contract for one JSONL finding |
...
| `provider_execution_in_tool_bucket` | `07_lib` exposes reusable capabilities, not provider invocation |
