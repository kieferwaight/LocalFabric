...
| Field | Value |
| --- | --- |
| ID | `image.text_ocr.extract.task` |
| Source | `07_tasks/image.text_ocr.extract.task.yaml` |
| Tags | task |
...
| --- | --- | --- | --- | --- |
| `path` | `string` | yes | `-` | [Extract OCR text from an image](image.text_ocr.extract.task.definition.md) |
...
| --- | --- | --- |
| Run | `python` | [Extract OCR text from an image](image.text_ocr.extract.task.definition.md) |
