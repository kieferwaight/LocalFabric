...
def_service_redis_service --> def_service_base["Service Abstraction Base"]
def_service_redis_service -.-> def_service_docker_mixin["Docker Backend Action Map"]
```
...
| `backend` | `docker` | [Redis Service (docker backend)](service.redis.service.definition.md) |
| `target` | `docker.redis.service` | [Redis Service (docker backend)](service.redis.service.definition.md) |
