...
def_schemas_generate_json_workflow --> def_stdlib_base["Abstract Base"]
```
...
| --- | --- | --- |
| Run | `schema_json` | [Generate Schema JSON](schemas.generate-json.workflow.definition.md) |
