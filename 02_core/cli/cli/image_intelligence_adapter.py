"""CLI adapter for the image-intelligence workflow."""
...
class ImageIntelligenceRunCommand(CliCommand):
    name = "run"
    help = "Run the image intelligence pipeline on all images in a collection."
...
class ImageIntelligenceSingleCommand(CliCommand):
    name = "single"
...
class ImageIntelligenceCliAdapter(CliAdapter):
    domain = "image_intelligence"
    typer_name = "image-intelligence"
    typer_help = "Image intelligence workflow."
    commands = [ImageIntelligenceRunCommand, ImageIntelligenceSingleCommand]
